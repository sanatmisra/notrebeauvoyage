...
export default function BackToTop() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-4 z-[60] inline-flex h-12 w-12 items-center justify-center rounded-full bg-gold text-ivory shadow-card md:bottom-8 md:right-8"
    >
